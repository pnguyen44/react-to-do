...
class Todos extends Component {
  ...
  render() {
    ...
    console.log('todos', todos)
    const todosComponent = todos.map(item => <TodoItem  key={item._id} item={item} flash={flash} onUpdateCompleted={this.onUpdateCompleted} onDeleteTodo={this.onDeleteTodo} onRenameTodo={this.onRenameTodo}/>)
