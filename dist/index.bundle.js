...
var _todosData = __webpack_require__(14);
  ...
  _createClass(App, [{
    ...
    value: function handleChange(id) {
      this.setState(function (prevState) {
        var updatedTodoItems = prevState.todos.map(function (item) {
          if (item.id === id) {
    ...
    value: function render() {
      ...
      var todoItemComponents = this.state.todos.map(function (item) {
...
var todosData = [{
    id: 1,
    text: "Do code challenges on HankerRank",
    completed: true
}, {
    id: 2,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', {
          ...
          onChange: function onChange() {
            return _this2.props.handleChange(_this2.props.item.id);
          }
        }),
